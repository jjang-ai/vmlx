...
if [ -z "$MODEL_PATH" ]; then
    FLEET=(
        "/Users/example/.mlxstudio/models/MLXModels/JANGQ-AI/Nemotron-Cascade-2-30B-A3B-JANG_4M"
        "/Users/example/.mlxstudio/models/MLXModels/JANGQ-AI/Gemma-4-31B-it-JANG_4M"
        "/Users/example/.mlxstudio/models/MLXModels/OsaurusAI/gemma-4-e2b-it-4bit"
    )
