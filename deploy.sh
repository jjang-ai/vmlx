...
rsync -avz --compress /Users/example/mlx/vllm-mlx/vllm_mlx/ macstudio:/Users/example/mlx/vllm-mlx/vllm_mlx/ 2>&1 | tail -3

echo "=== Step 2: Build Electron app ==="
cd /Users/example/mlx/vllm-mlx/panel
...
APP_PATH=$(find /Users/example/mlx/vllm-mlx/panel/release -name "vMLX.app" -type d -maxdepth 3 | head -1)
if [ -z "$APP_PATH" ]; then
