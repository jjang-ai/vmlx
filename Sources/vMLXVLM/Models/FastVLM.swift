...
public struct FastVLMProcessor: UserInputProcessor {
    ...
    public func prepare(input: vMLXLMCommon.UserInput) async throws -> vMLXLMCommon.LMInput {
...
public class FastVLM: Module, VLMModel, KVCacheDimensionProvider {
        ...
        -> PrepareResult
    {
        ...
        // Chunked prefill — see Qwen25VL / vmlx #50/#51.
...
public struct FastVLMMessageGenerator: MessageGenerator {
    ...
    public func generate(messages: [Chat.Message]) -> [vMLXLMCommon.Message] {
