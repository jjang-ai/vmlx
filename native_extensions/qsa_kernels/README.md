...
> This vendored README describes the original MTPLX integration. For the
> vMLX build, serving adapter, and supported dispatch path, use
> [VMLX_INTEGRATION.md](VMLX_INTEGRATION.md). MTPLX application and release
> commands below do not apply to this repository.
