...
"""
Performance Benchmark for vmlx-engine.
...
Usage:
    # LLM benchmark
    python -m vmlx_engine.benchmark --model mlx-community/Llama-3.2-1B-Instruct-4bit
    python -m vmlx_engine.benchmark --model mlx-community/Llama-3.2-3B-Instruct-4bit --prompts 10 --max-tokens 256

    # MLLM image benchmark (auto-detected or use --mllm flag)
    python -m vmlx_engine.benchmark --model mlx-community/Qwen3-VL-4B-Instruct-3bit
    python -m vmlx_engine.benchmark --model mlx-community/Qwen3-VL-4B-Instruct-3bit --mllm --quick

    # MLLM video benchmark
    python -m vmlx_engine.benchmark --model mlx-community/Qwen3-VL-4B-Instruct-3bit --video
    python -m vmlx_engine.benchmark --model mlx-community/Qwen3-VL-4B-Instruct-3bit --video --video-url https://example.com/video.mp4
"""
...
def run_benchmark(
    ...
    print(f"\n{'='*60}")
    print("vmlx-engine Performance Benchmark")
    print(f"{'='*60}")
...
def run_mllm_benchmark(
    ...
    print(f"\n{'='*70}")
    print("vmlx-engine MLLM Performance Benchmark")
    print(f"{'='*70}")
...
def run_video_benchmark(
    ...
    print(f"\n{'='*70}")
    print("vmlx-engine Video Performance Benchmark")
    print(f"{'='*70}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="vmlx-engine Performance Benchmark (LLM, MLLM Image & Video)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    # LLM benchmark
    vmlx-engine-bench --model mlx-community/Llama-3.2-1B-Instruct-4bit
    vmlx-engine-bench --model mlx-community/Llama-3.2-3B-Instruct-4bit --prompts 10

    # MLLM image benchmark (auto-detected)
    vmlx-engine-bench --model mlx-community/Qwen3-VL-4B-Instruct-3bit
    vmlx-engine-bench --model mlx-community/Qwen3-VL-4B-Instruct-3bit --quick

    # MLLM video benchmark
    vmlx-engine-bench --model mlx-community/Qwen3-VL-4B-Instruct-3bit --video
    vmlx-engine-bench --model mlx-community/Qwen3-VL-4B-Instruct-3bit --video --quick
    vmlx-engine-bench --model mlx-community/Qwen3-VL-4B-Instruct-3bit --video --video-url https://example.com/video.mp4

    # Force MLLM mode
    vmlx-engine-bench --model custom-vision-model --mllm
        """,
    )
    parser.add_argument(
        "--model",
