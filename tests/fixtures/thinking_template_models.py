...
AT_RISK_MODELS: List[ThinkingTemplateModel] = [
    ThinkingTemplateModel(
        ...
        model_path=Path("/Users/example/models/dealign.ai/Ling-2.6-flash-JANGTQ2-CRACK"),
    ...
    ThinkingTemplateModel(
        ...
        family="nemotron_h",
        model_path=Path("/Users/example/models/dealign.ai/Nemotron-Omni-Nano-JANGTQ-CRACK"),
        think_in_template=False,
        sample_user_message=_SAMPLE,
    ),
    ThinkingTemplateModel(
        ...
        family="gemma4",
        model_path=Path("/Users/example/models/dealign.ai/Gemma-4-26B-A4B-it-JANG_4M-CRACK"),
        think_in_template=False,
        sample_user_message=_SAMPLE,
    ),
]
...
SANITY_MODELS: List[ThinkingTemplateModel] = [
    ThinkingTemplateModel(
        ...
        family="deepseek_v4",
        model_path=Path("/Users/example/models/JANGQ/DeepSeek-V4-Flash-JANGTQ"),
    ...
    ThinkingTemplateModel(
        ...
        family="minimax_m2",
        model_path=Path("/Users/example/models/JANGQ/MiniMax-M2.7-JANGTQ_K"),
        think_in_template=True,
        sample_user_message=_SAMPLE,
    ),
    ThinkingTemplateModel(
        ...
        family="qwen3_5",
        model_path=Path("/Users/example/models/dealign.ai/Qwen3.6-27B-JANG_4M-CRACK"),
        think_in_template=True,
        sample_user_message=_SAMPLE,
    ),
    ThinkingTemplateModel(
        ...
        family="qwen3_5_moe",
        model_path=Path("/Users/example/models/dealign.ai/Qwen3.6-35B-A3B-JANGTQ-CRACK"),
        think_in_template=True,
        sample_user_message=_SAMPLE,
    ),
    ThinkingTemplateModel(
        ...
        family="kimi_k25",
        model_path=Path("/Users/example/models/JANGQ/Kimi-K2.6-Small-JANGTQ"),
        think_in_template=True,
        sample_user_message=_SAMPLE,
    ),
]
