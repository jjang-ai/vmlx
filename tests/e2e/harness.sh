...
set -u
CLI="${CLI:-/Users/example/vmlx/swift/.build/arm64-apple-macosx/release/vmlxctl}"
...
case_audio_transcription() {
    ...
    local wav=""
    for cand in \
        /Users/example/.cache/huggingface/hub/models--mlx-community--whisper-tiny-mlx/snapshots/*/test.wav \
        /Users/example/vmlx/swift/tests/e2e/fixtures/hello.wav; do
