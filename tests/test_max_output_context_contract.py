def test_max_output_context_contract_covers_all_public_api_surfaces():
    ...
    assert "test_ollama_nonstream_num_predict_overrides_server_default_without_touching_context_cap" in joined_commands
    ...
    assert "test_ollama_nonstream_num_predict_overrides_server_default_without_touching_context_cap" in required
