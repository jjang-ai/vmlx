...
NATIVE_MTP_CONTRACT_REL = "build/current-native-mtp-contract-after-qwen-gdn-sink-proof-20260606.json"
VL_MEDIA_CONTRACT_REL = "build/current-vl-media-cache-contract-after-gemma4-prefill-guard-proof-20260606.json"
