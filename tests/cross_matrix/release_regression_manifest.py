...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/summarize_objective_proof.py --out build/current-objective-proof-after-mimo-jangtq2-source-quant-preflight-refresh-20260607.json",
