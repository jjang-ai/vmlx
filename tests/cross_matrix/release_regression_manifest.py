...
CURRENT_RELEASE_REGRESSION_MANIFEST_ARTIFACT = (
    "build/current-release-regression-manifest-after-mimo-audios-signature-filter-20260608.json"
)
...
CURRENT_MIMO_V2_JANG2L_NO_SOURCE_EXACTNESS_CLASSIFIER_ARTIFACT = (
    "build/current-mimo-v2-no-source-exactness-classifier-after-audios-signature-filter-20260608.json"
)
...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "artifacts": [
            "build/current-objective-proof-after-mimo-audios-signature-filter-20260608.json",
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/summarize_objective_proof.py --out build/current-objective-proof-after-mimo-audios-signature-filter-20260608.json",
    ...
    },
    {
        ...
        "commands": [
            ...
            "VMLINUX_BENCH_ISOLATED=1 VMLINUX_BENCH_PYTHON=panel/bundled-python/python/bin/python3.12 .venv/bin/python bench/all_local_model_smoke.py --models-root /Users/example/models --only DeepSeek-V4-Flash-JANGTQ-K --max-models 1 --no-media --no-video --port 8853 --load-timeout-s 900 --request-timeout-s 300 --out build/current-all-local-model-smoke-dsv4-jangtq-k-tools-cache-20260606",
        ],
        "artifacts": [
