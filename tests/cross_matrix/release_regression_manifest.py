...
CURRENT_REGRESSION_SUITE_ARTIFACT = (
    "build/current-regression-suite-after-zaya-vl-no-media-refresh-20260606.json"
)
...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "artifacts": [
            "build/current-objective-proof-after-zaya-vl-no-media-refresh-20260606.json",
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/summarize_objective_proof.py --out build/current-objective-proof-after-zaya-vl-no-media-refresh-20260606.json",
