...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "artifacts": [
            "build/current-objective-proof-after-mimo-l2-restart-20260608.json",
    ...
    },
    {
        ...
        "commands": [
            ".venv/bin/python tests/cross_matrix/summarize_objective_proof.py --out build/current-objective-proof-after-mimo-l2-restart-20260608.json",
