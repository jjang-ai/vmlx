...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ...
            ".venv/bin/python tests/cross_matrix/run_installed_app_runtime_parity_audit.py --out build/current-installed-app-runtime-parity-audit-20260602-v1553-installed-tahoe.json",
