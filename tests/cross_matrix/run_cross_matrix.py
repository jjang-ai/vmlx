...
ROWS = [
    dict(
        ...
        path="/Users/example/jang/models/Qwen3.5-4B-JANG_4K",
        is_vl=False,
    ...
    dict(
        ...
        path="/Users/example/jang/models/Gemma-4-26B-A4B-it-JANG_4M",
        is_vl=False,
        backend="paged_blockdisk",
        kv_quant="none",
    ...
    dict(
        ...
        path="/Users/example/.mlxstudio/models/Qwen3.5-VL-4B-JANG_4S-CRACK",
        is_vl=True,
        backend="paged_blockdisk",
        kv_quant="none",
    ...
    dict(
        ...
        path="/Users/example/.mlxstudio/models/Nemotron-Cascade-2-30B-A3B-JANG_2L-CRACK",
        is_vl=False,
        backend="paged_blockdisk",
        kv_quant="none",
    ...
    dict(
        ...
        path="/Users/example/models/Mistral-Small-4-119B-JANG_4M-CRACK",
        is_vl=False,
        backend="paged_blockdisk",
        kv_quant="none",
    ...
    dict(
        ...
        path="/Users/example/.mlxstudio/models/MiniMax-M2.5-JANG_2L-CRACK",
        is_vl=False,
        backend="paged",
        kv_quant="none",
...
def start_server(row):
    ...
    with open(log, "w") as lf:
        ...
        p = subprocess.Popen(
            ...
            env=os.environ.copy(),
            cwd="/Users/example/mlx/vllm-mlx",
        )
    return p, log
