...
DEFAULT_OUT = Path(
    "build/current-full-release-objective-checklist-after-mllm-inputs-embeds-proof-20260609.json"
)
...
OBJECTIVE_DIGEST = Path(
    "build/current-objective-proof-after-mllm-inputs-embeds-proof-20260609.json"
)
ISSUE179_AUDIT = Path(
