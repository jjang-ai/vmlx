...
DEFAULT_OUT = Path(
    "build/current-full-release-objective-checklist-after-mimo-audios-signature-filter-20260608.json"
)
...
def _build(root: Path) -> dict[str, Any]:
    ...
    groups = {
        ...
        + _qwen_installed_video_checks(
            ...
            expected_model="/Users/example/models/JANGQ/Qwen3.6-27B-JANG_4M-MTP",
            expected_depth=3,
        )
        ...
        + _qwen_installed_video_checks(
            ...
            expected_model="/Users/example/models/JANGQ/Qwen3.6-35B-A3B-MXFP8-MTP",
            expected_depth=3,
        ),
