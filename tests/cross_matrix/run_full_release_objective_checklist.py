...
DEFAULT_OUT = Path(
    "build/current-full-release-objective-checklist-after-current-jangtq2-l2-proof-20260609.json"
)

MIMO_AUDIT = Path(
    "build/current-mimo-v2-jang2l-current-audit-after-current-jangtq2-l2-proof-20260609.json"
)
...
OBJECTIVE_DIGEST = Path(
    "build/current-objective-proof-after-current-jangtq2-l2-proof-20260609.json"
)
ISSUE179_AUDIT = Path(
