                ...
                "real_ui_live_model_matrix": {
                    ...
                    "covered_families": {
                        "zaya_text": {
                            "status": "pass",
                            "artifact": (
                                "build/private-evidence/current-real-ui-live-model-zaya-text-responses-runcommand-tools-20260527-proof.json"
                            ),
                            "covered_surfaces": [
                                "chat_completions",
                                "responses_api",
                        ...
                        "gemma4": {
                            "status": "pass",
                            "artifact": (
                                "build/private-evidence/current-real-ui-live-model-gemma4-cachecontrols-20260527-proof.json"
                            ),
                            "covered_surfaces": [
                                "chat_completions",
                                "responses_api",
