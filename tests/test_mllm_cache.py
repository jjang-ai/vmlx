...
class TestMLXMultimodalLMCache:
    ...
    def test_chat_image_prefix_hit_passes_prompt_cache_state_to_mlx_vlm(
        ...
        """Image-prefix hits must use mlx-vlm's PromptCacheState handoff."""
        from types import SimpleNamespace
    ...
    def test_generate_image_prefix_hit_passes_prompt_cache_state_to_mlx_vlm(
        ...
        """Direct image generation uses the same safe mlx-vlm prefix handoff."""
        from types import SimpleNamespace
        ...
        monkeypatch.setattr(
            ...
            "apply_chat_template",
            lambda *_args, **_kwargs: "new formatted prompt",
        )
    ...
    def test_generate_image_cache_miss_stores_prompt_boundary_only(
        ...
        """Direct image generation must not persist generated-token cache tails."""
        from types import SimpleNamespace
        ...
        def _fake_generate(*_args, **_kwargs):
            return SimpleNamespace(text="ok", prompt_tokens=4, generation_tokens=2)
    ...
    def test_stream_chat_image_prefix_hit_passes_prompt_cache_state_to_mlx_vlm(
        ...
        """Streaming image-prefix hits must use the same safe mlx-vlm handoff."""
        from types import SimpleNamespace
