...
def test_release_regression_manifest_tracks_new_chat_output_cap_inheritance_guard():
    ...
    assert "current-max-output-context-contract-20260522-chat-responses-streaming.json" in joined
...
def test_release_regression_manifest_tracks_api_surface_with_runner_artifact():
    ...
    assert "current-api-surface-contract-20260522-ollama-streaming.json" in joined
